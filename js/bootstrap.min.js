...
+ function(a) {
	...
	b.DEFAULTS = a.extend({}, a.fn.tooltip.Constructor.DEFAULTS, {
		...
		var a = this.tip(),
			b = this.getTitle(),
			c = this.getContent();
		a.find(".popover-title")[this.options.html ? "html" : "text"](b), a.find(".popover-content")[this.options.html ? "text" : "html"](c), a.removeClass("fade top bottom left right in"), a.find(".popover-title").html() || a.find(".popover-title").hide()
	}, b.prototype.hasContent = function() {
		...
		var a = this.$element,
			...
			// 
		var str=a.attr("data-content");
			// return a.attr("data-content")

		return str || (typeof b.content == "function" ? b.content.call(a[0]) : b.content)
	}, b.prototype.arrow = function() {
